...
<body>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="" method="post">
									...
									<div class="mb-3">
										<label for="tgsurat" class="col-form-label">Tanggal Surat</label>
										<input type="date" class="form-control" id="tgsurat" name="tglsurat">
									</div>
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="filesurat" name="surat">
									</div>
	...
	<script>
		$(document).on("click","#tombolUbah", function () {
			...
			$('.modal-body #tgsurat').val(tgsurat);
